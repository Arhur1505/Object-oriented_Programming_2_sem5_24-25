...
public class Library{
    ...
    public void checkUserAccount(User user, int currentDayOfYear){
        double totalFine = 0;
        System.out.println(user.getName() + " account status:");
    ...
    public void borrowItem(int itemId, User user, int currentDayOfYear, double fineThreshold) {
        ...
        if(item.isBorrowed()){
            System.out.println("Item with id: " + itemId + " has been already borrowed.");
            return;
        }
        ...
        System.out.println("Item with id: " + itemId + " has been borrowed by " + user.getName() + " on " + currentDayOfYear + ".");
    }
